...
head(reviews,2)
head(solutions,2)
#"solution_id" in reviews="id" in solutions

#merge()
names(reviews)
names(solutions)
# by default, merge() will merge two datasets by all their common names
...
# only can merge common names between the two datasets
library(plyr)
